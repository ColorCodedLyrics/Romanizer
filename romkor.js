...
syl = syl.replace(/짧/g, "jjalp");
syl = syl.replace(/짬/g, "jjam");
syl = syl.replace(/짭/g, "jjap");
...
syl = syl.replace(/dobn/g, "domn");
syl = syl.replace(/dobr/g, "domn");
...
syl = syl.replace(/dubn/g, "dumn");
syl = syl.replace(/dubr/g, "dumn");
syl = syl.replace(/dubm/g, "dumm");
syl = syl.replace(/dusg/g, "dutg");
syl = syl.replace(/dusn/g, "dutn");
syl = syl.replace(/dusd/g, "dutt");
syl = syl.replace(/dusm/g, "dunm");
syl = syl.replace(/dusp/g, "dutp");
...
syl = syl.replace(/debn/g, "demn");
syl = syl.replace(/debr/g, "demn");
...
//syl = syl.replace(/budd/g, "butt"); //buddy
...
syl = syl.replace(/ipsuleul/g, "ipsureul"); //입술을 
syl = syl.replace(/bogothibdago /g, "bogoshiptago"); //보고싶다고 
syl = syl.replace(/shipdago /g, "shiptago"); //싶다고 
syl = syl.replace(/maleul/g, "mareul"); //말을 
syl = syl.replace(/muleul/g, "mureul"); 
syl = syl.replace(/dadhyeo/g, "dachyeo"); //닫혀
syl = syl.replace(/najbuteo/g, "natbuteo"); 
syl = syl.replace(/gatji/g, "gajji"); //갖질 
syl = syl.replace(/majchun/g, "matchun"); 
syl = syl.replace(/hashage/g, "hathage"); 
...
syl = syl.replace(/yeonghwaye/g, "yeonghwae"); //영화의
syl = syl.replace(/bimirye/g, "bimire"); //비밀의
syl = syl.replace(/bimirye/g, "bimire"); //비밀의
...
syl = syl.replace(/nalaga/g, "naraga");
syl = syl.replace(/nalaolla/g, "naraolla");
syl = syl.replace(/anhge/g, "ange");
syl = syl.replace(/daedabhae/g, "daedaphae");
syl = syl.replace(/nasjil/g, "natjil");
syl = syl.replace(/beob/g, "beop");
syl = syl.replace(/buleoneoheojweo/g, "bureoneoheojweo");
syl = syl.replace(/geosi/g, "geoshi");
syl = syl.replace(/chueoke/g, "chueoge");
syl = syl.replace(/geuribge/g, "geuripge");
syl = syl.replace(/notchilkka/g, "nochilkka");
syl = syl.replace(/noheun/g, "noeun");
...
syl = syl.replace(/keutnal/g, "keunnal");
syl = syl.replace(/keutnan/g, "keunnan");
syl = syl.replace(/babogati/g, "babogachi");
syl = syl.replace(/sala/g, "sara");
syl = syl.replace(/bujoghajiman/g, "bujokhajiman");
syl = syl.replace(/maleun/g, "mareun");
syl = syl.replace(/useubgedo/g, "useupgedo");
syl = syl.replace(/usgo/g, "utgo");
syl = syl.replace(/geuribda/g, "geuripda");
syl = syl.replace(/sashili/g, "sashiri");
syl = syl.replace(/gwaenchanhjiga/g, "gwaenchanjiga");
syl = syl.replace(/gieogmada/g, "gieongmada");
syl = syl.replace(/nunbushyeo/g, "nunbusheo");
syl = syl.replace(/hayahke/g, "hayake");
syl = syl.replace(/kkeutnae/g, "kkeunnae");
syl = syl.replace(/eumake/g, "eumage");
syl = syl.replace(/jjarishal/g, "jjarithal");
syl = syl.replace(/bimili/g, "bimiri");
syl = syl.replace(/manhajyeosseo/g, "manajyeosseo");
syl = syl.replace(/jjarishande/g, "jjarithande");
...
syl = syl.replace(/nalabwa/g, "narabwa");
syl = syl.replace(/mugmukhi/g, "mukmukhi");
syl = syl.replace(/midjyo/g, "mitjyo");
syl = syl.replace(/saegeo/g, "saegyeo");
syl = syl.replace(/dahke/g, "dake");
syl = syl.replace(/gyejeoli/g, "gyejeori");
syl = syl.replace(/gitbaleul/g, "gitbareul");
syl = syl.replace(/naleul/g, "nareul");
syl = syl.replace(/manhayo/g, "manayo");
syl = syl.replace(/malayo/g, "marayo");
syl = syl.replace(/joheunikka/g, "joeunikka");
syl = syl.replace(/nalawa/g, "narawa");
syl = syl.replace(/nalagalgeyo/g, "naragalgeyo");
syl = syl.replace(/jeongdoye/g, "jeongdoe");
syl = syl.replace(/naeileul/g, "naeireul");
syl = syl.replace(/gongganeseoye/g, "gongganeseoe");
syl = syl.replace(/jibchak/g, "jipchak");
syl = syl.replace(/dracura/g, "dracula");
syl = syl.replace(/jabgo/g, "japgo");
syl = syl.replace(/cheos/g, "cheot");
syl = syl.replace(/mueosideun/g, "mueoshideun");
syl = syl.replace(/geugeosi/g, "geugeoshi");
syl = syl.replace(/cororro/g, "colorro");
syl = syl.replace(/naojianha/g, "naojiana");
syl = syl.replace(/jageobshileseo/g, "jageopshileseo");
syl = syl.replace(/paledala/g, "paredara");
syl = syl.replace(/dwaessgo/g, "dwaetgo");
syl = syl.replace(/meomchwosseo/g, "meomchweosseo");
syl = syl.replace(/salaitji/g, "saraitji");
syl = syl.replace(/shibda/g, "shipda");
syl = syl.replace(/kkeuleoandeon/g, "kkeureoandeon");
syl = syl.replace(/amureohji/g, "amureochi");
syl = syl.replace(/alabwa/g, "arabwa");
syl = syl.replace(/ileukyeo/g, "ireukyeo");
syl = syl.replace(/Excaribur/g, "Excalibur");
syl = syl.replace(/nalabwa/g, "narabwa");
...
syl = syl.replace(/dolikyeodo/g, "dorikyeodo");
syl = syl.replace(/puleoseo/g, "pureoseo");
syl = syl.replace(/noha/g, "noa");
syl = syl.replace(/oneuleul/g, "oneureul");
syl = syl.replace(/heurishaetteon/g, "heurithaetteon");
syl = syl.replace(/tteostteoshi/g, "tteottteoshi");
syl = syl.replace(/noli/g, "nori");
syl = syl.replace(/seullingsyas/g, "seullingshyat");
syl = syl.replace(/hejipeo/g, "hejibeo");
syl = syl.replace(/gieogmajeo/g, "gieokmajeo");
syl = syl.replace(/eojesbamedo/g, "eojetbamedo");
syl = syl.replace(/kkoch/g, "kkot");
syl = syl.replace(/shibeunde/g, "shipeunde");
...
syl = syl.replace(/yyelmuihan/g, "yuilmuihan");
syl = syl.replace(/chajji/g, "chatji");
syl = syl.replace(/nohil/g, "noil");
syl = syl.replace(/gosini/g, "goshini");
syl = syl.replace(/alreuksandeuro/g, "alleuksandeuro");
syl = syl.replace(/jjaris/g, "jjarit");
syl = syl.replace(/arive/g, "alive");
syl = syl.replace(/anha/g, "ana");
syl = syl.replace(/dapi/g, "dabi");
syl = syl.replace(/Christmat/g, "Christmas");
syl = syl.replace(/dale/g, "dare");
syl = syl.replace(/gile/g, "gire");
...
syl = syl.replace(/shage/g, "shake");
syl = syl.replace(/haesbit/g, "haetbit");
syl = syl.replace(/goth/g, "gosh");
...
syl = syl.replace(/jopeun/g, "jobeun");
syl = syl.replace(/kkeunhimeopshi/g, "kkeunimeopshi");
syl = syl.replace(/neujji/g, "neutji");
syl = syl.replace(/huljjeokkeorideora/g, "huljjeokgeorideora");
syl = syl.replace(/balka/g, "balga");
syl = syl.replace(/gati/g, "gachi");
syl = syl.replace(/gamani/g, "gamanhi");
syl = syl.replace(/gadhigeona/g, "gachigeona");
syl = syl.replace(/jigyeojweo/g, "jikyeojweo");
syl = syl.replace(/seutepeul/g, "seutebeul");
syl = syl.replace(/beopeul/g, "beobeul");
syl = syl.replace(/eumaki/g, "eumagi");
syl = syl.replace(/mulgamdeuleul/g, "mulgamdeureul");
syl = syl.replace(/byeoke/g, "byeoge");
syl = syl.replace(/shinbaleun/g, "shinbareun");
syl = syl.replace(/eumakinji/g, "eumaginji");
syl = syl.replace(/bujoghan/g, "bujokhan");
...
syl = syl.replace(/osjangeul/g, "otjangeul");
syl = syl.replace(/naeileun/g, "naeireun");
syl = syl.replace(/bulanan/g, "buranhan");
syl = syl.replace(/bith/g, "bish");
syl = syl.replace(/raepeuro/g, "raebeuro");
syl = syl.replace(/tashae/g, "tathae");
syl = syl.replace(/moseupeun/g, "moseubeun");
syl = syl.replace(/majchulge/g, "matchulge");
syl = syl.replace(/baljagugman/g, "baljagungman");
syl = syl.replace(/Pirots/g, "Pilots");
syl = syl.replace(/Garaxy/g, "Galaxy");
syl = syl.replace(/stonet/g, "stones");
syl = syl.replace(/beoryeossgun/g, "beoryeotgun");
syl = syl.replace(/bulkkoti/g, "bulkkochi");
syl = syl.replace(/kkamahke/g, "kkamake");
syl = syl.replace(/kkojhyeobeorillae/g, "kkochyeobeorillae");
syl = syl.replace(/jopajyeo/g, "jobajyeo");
syl = syl.replace(/neugeushae/g, "neugeuthae");
syl = syl.replace(/majchugo/g, "matchugo");
syl = syl.replace(/nachseoreo/g, "natsseoreo");
...
syl = syl.replace(/seteul/g, "seseul");
syl = syl.replace(/seti/g, "seshi");
syl = syl.replace(/seteun/g, "seseun");
syl = syl.replace(/meotneun/g, "meonneun");
syl = syl.replace(/anhji/g, "anchi");
syl = syl.replace(/madnets/g, "madness");
syl = syl.replace(/ppalgahke/g, "ppalgake");
syl = syl.replace(/kkeunheonael/g, "kkeuneonael");
syl = syl.replace(/midnabwa/g, "minnabwa");
syl = syl.replace(/jutge/g, "judge");
syl = syl.replace(/geojisingeol/g, "geojishingeol");
syl = syl.replace(/Honett/g, "Honest");
syl = syl.replace(/wirobadji/g, "wirobatji");
syl = syl.replace(/chesbagwi/g, "chetbakwi");
syl = syl.replace(/Shage/g, "Shake");
syl = syl.replace(/heutnallineun/g, "heunnallineun");
syl = syl.replace(/rearize/g, "realize");
syl = syl.replace(/deoschilhallae/g, "deotchilhallae");
syl = syl.replace(/remnesenting/g, "representing");
syl = syl.replace(/saekkamahke/g, "saekkamake");
syl = syl.replace(/rearity/g, "reality");
syl = syl.replace(/jece/g, "juice");
syl = syl.replace(/budijhyeodo /g, "budichyeodo");
syl = syl.replace(/jwajeoli/g, "jwajeori");
syl = syl.replace(/neujchul/g, "neutchul");
syl = syl.replace(/beoreuseoptago/g, "beoreudeopttago");
syl = syl.replace(/mathigo/g, "mashigo");
syl = syl.replace(/shagy/g, "shaky");
syl = syl.replace(/neutni/g, "neunni");
syl = syl.replace(/johji/g, "jochi");
syl = syl.replace(/anhda/g, "anta");
syl = syl.replace(/mott/g, "most");
syl = syl.replace(/dwaessgeon/g, "dwaetgeon");
...
syl = syl.replace(/meojji/g, "meotji");
syl = syl.replace(/ipeul/g, "ibeul");
syl = syl.replace(/gatne/g, "ganne");
syl = syl.replace(/kkeunhgesseo/g, "kkeunkesseo");
...
syl = syl.replace(/anhnyago/g, "annyago");
syl = syl.replace(/gajji/g, "gatji");
syl = syl.replace(/usjana/g, "utjana");
syl = syl.replace(/amel/g, "amuil");
syl = syl.replace(/chosbulcheoreom/g, "chotbulcheoreom");
...
syl = syl.replace(/caramuil/g, "caramel");
syl = syl.replace(/loophore/g, "loophole");
syl = syl.replace(/majchulkkayo/g, "matchulkkayo");
syl = syl.replace(/hashan/g, "hathan");
syl = syl.replace(/jipeosamkyeo/g, "jibeosamkyeo");
syl = syl.replace(/eoknullyeotteon/g, "eongnullyeotteon");
syl = syl.replace(/maedeupeul/g, "maedeubeul");
syl = syl.replace(/eoryeompushan/g, "eoryeomputhan");
syl = syl.replace(/anhjana/g, "anchana");
syl = syl.replace(/jogangan/g, "jogangnan");
syl = syl.replace(/goseteo/g, "goseseo");
syl = syl.replace(/jigige/g, "jikige");
syl = syl.replace(/gallanoheuryeo/g, "gallanoeuryeo");
syl = syl.replace(/mosta/g, "motta");
syl = syl.replace(/smoge/g, "smoke");
syl = syl.replace(/arign/g, "align");
syl = syl.replace(/mittle/g, "middle");
syl = syl.replace(/keotseo/g, "keosseo");
syl = syl.replace(/mangae/g, "mangnae");
syl = syl.replace(/eojesbam/g, "eojetbam");
syl = syl.replace(/datty/g, "daddy");
syl = syl.replace(/roset/g, "roses");
syl = syl.replace(/kisset/g, "kisses");
syl = syl.replace(/najchumyeo/g, "natchumyeo");
syl = syl.replace(/majji/g, "matji");
syl = syl.replace(/obsetsed/g, "obsessed");
syl = syl.replace(/detperate/g, "desperate");
syl = syl.replace(/nethi/g, "neshi");
syl = syl.replace(/nasseon/g, "natsseon");
syl = syl.replace(/moseupeul/g, "moseubeul");
syl = syl.replace(/seshingeun/g, "setingeun");
syl = syl.replace(/beld/g, "build");
syl = syl.replace(/haration/g, "halation");
syl = syl.replace(/heumchis/g, "heumchit");
syl = syl.replace(/mostwen/g, "motdwen");
syl = syl.replace(/britge/g, "bridge")
syl = syl.replace(/ipryeokhae/g, "imnyeokhae");
syl = syl.replace(/recibe/g, "recipe");
syl = syl.replace(/mathineun/g, "mashineun");
syl = syl.replace(/intetion/g, "intuition");
syl = syl.replace(/heurishaejineun/g, "heurithaejineun");
syl = syl.replace(/kkeunhgyeo/g, "kkeunkyeo");
syl = syl.replace(/budijhyeo/g, "budichyeo");
syl = syl.replace(/ilheul/g, "ireul");
syl = syl.replace(/ararm/g, "alarm");
syl = syl.replace(/rachata/g, "ratata")
syl = syl.replace(/sethyeoneul/g, "seshyeoneul");
syl = syl.replace(/deudji/g, "deutji");
syl = syl.replace(/anhdeorado/g, "anteorado");
syl = syl.replace(/snage/g, "snake");
syl = syl.replace(/gitty/g, "giddy");
syl = syl.replace(/stupidnets/g, "stupidness");
syl = syl.replace(/neolpeun/g, "neolbeun");
syl = syl.replace(/iljel/g, "iljuil");
syl = syl.replace(/dalhdorok/g, "daltorok");
syl = syl.replace(/deuneolpji/g, "deuneolji");
syl = syl.replace(/shigyesbaneuri/g, "shigetbaneuri");
syl = syl.replace(/jjalpa/g, "jjalba");
syl = syl.replace(/budijhineun/g, "buditchineun");
syl = syl.replace(/boassgo/g, "boatgo");
syl = syl.replace(/bandeuthi/g, "bandeushi");
syl = syl.replace(/namateo/g, "namaseo");
syl = syl.replace(/heurishaejin/g, "heurithaejin");
syl = syl.replace(/namateo/g, "namaseo");
syl = syl.replace(/mueoshana/g, "mueotana");
syl = syl.replace(/anheumi/g, "aneumi");
syl = syl.replace(/hanatshik/g, "hanasshik");
syl = syl.replace(/jjirisjjiris/g, "jjiritjjirit");
syl = syl.replace(/mangseoliji/g, "mangseoriji");
syl = syl.replace(/yyel/g, "yuil");
syl = syl.replace(/yuilme/g, "yuilmui");
syl = syl.replace(/Lonelinets/g, "Loneliness");
syl = syl.replace(/dolikil/g, "dorikil");
syl = syl.replace(/jjirishake/g, "jjirithage");
syl = syl.replace(/mateyo/g, "maseyo");
syl = syl.replace(/barathimyeon/g, "barashimyeon");
syl = syl.replace(/qet/g, "quit");
syl = syl.replace(/derusion/g, "delusion");
syl = syl.replace(/fret/g, "fruit");
syl = syl.replace(/arike/g, "alike");
syl = syl.replace(/emptinets/g, "emptiness");
syl = syl.replace(/mothi/g, "moshi");
syl = syl.replace(/emptinets/g, "emptiness");
syl = syl.replace(/crath/g, "crash");
syl = syl.replace(/thrath/g, "thrash");
syl = syl.replace(/kkeunhgiji/g, "kkeunkiji");
syl = syl.replace(/ttatteushal/g, "ttatteutal");
syl = syl.replace(/gyeouleul/g, "gyeoureul");
syl = syl.replace(/keuriseumateu/g, "keuriseumaseu");
syl = syl.replace(/jithi/g, "jishi");
syl = syl.replace(/daji/g, "dachi");
syl = syl.replace(/jigiji/g, "jikiji");
syl = syl.replace(/fragire/g, "fragile");
syl = syl.replace(/biseonae/g, "bijeonae");
syl = syl.replace(/adrenarine/g, "adrenaline");
syl = syl.replace(/vamot/g, "vamos");
syl = syl.replace(/qeck/g, "quick");
syl = syl.replace(/arien/g, "alien");
syl = syl.replace(/civirian/g, "civilian");
syl = syl.replace(/shamuiless/g, "shameless");
syl = syl.replace(/businets/g, "business");
syl = syl.replace(/heos/g, "heot");
