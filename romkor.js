...
syl = syl.replace(/clazy/g, "crazy");
syl = syl.replace(/alae/g, "arae");
syl = syl.replace(/nohil/g, "noil");
syl = syl.replace(/gosini/g, "goshini");
syl = syl.replace(/milael/g, "mirael");
syl = syl.replace(/neolan/g, "neoran");
...
syl = syl.replace(/stlaight/g, "straight");
syl = syl.replace(/anha/g, "ana");
syl = syl.replace(/olae/g, "orae");
syl = syl.replace(/dapi/g, "dabi");
syl = syl.replace(/Christmat/g, "Christmas");
syl = syl.replace(/palanbul/g, "paranbul");
...
syl = syl.replace(/shage/g, "shake");
syl = syl.replace(/aflaid/g, "afraid");
...
syl = syl.replace(/bulane/g, "burane");
syl = syl.replace(/jopeun/g, "jobeun");
syl = syl.replace(/hanshilado/g, "hanshirado");
syl = syl.replace(/kkeunhimeopshi/g, "kkeunimeopshi");
syl = syl.replace(/kkumelado/g, "kkumerado");
syl = syl.replace(/bolatbit/g, "boratbit");
syl = syl.replace(/hamkkelamyeon/g, "hamkkeramyeon");
syl = syl.replace(/neujji/g, "neutji");
syl = syl.replace(/huljjeokkeorideola/g, "huljjeokgeorideora");
syl = syl.replace(/balka/g, "balga");
syl = syl.replace(/gati/g, "gachi");
syl = syl.replace(/gamani/g, "gamanhi");
syl = syl.replace(/glavity/g, "gravity");
syl = syl.replace(/gadhigeona/g, "gachigeona");
syl = syl.replace(/yulanghae/g, "yuranghae");
...
syl = syl.replace(/nolabwa/g, "norabwa");
syl = syl.replace(/ipeo/g, "ibeo");
syl = syl.replace(/eumaki/g, "eumagi");
syl = syl.replace(/mulgamdeuleul/g, "mulgamdeureul");
syl = syl.replace(/byeoke/g, "byeoge");
syl = syl.replace(/Glaffiti/g, "Graffiti");
syl = syl.replace(/dlawing/g, "drawing");
syl = syl.replace(/tlacks/g, "tracks");
syl = syl.replace(/shinbaleun/g, "shinbareun");
syl = syl.replace(/eumakinji/g, "eumaginji");
syl = syl.replace(/glaceful/g, "graceful");
...
syl = syl.replace(/laepeuro/g, "raebeuro");
syl = syl.replace(/milae/g, "mirae");
syl = syl.replace(/laneun/g, "raneun");
syl = syl.replace(/tashae/g, "tathae");
syl = syl.replace(/chulakhae/g, "churakhae");
